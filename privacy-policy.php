...
<html class="no-js hover js--masthead-hidden" lang=en-gb data-js="toggled nav parent">
   <head>
      ...
      <title>Privacy Policy | Get Your Logo Design</title>
...
<section class="padding-section privacyPolicy privacy-text-wrapper">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="margin-bottom-20">
          <h3>About The Policy</h3>
          <p>At Get Your Logo Design, the privacy of our clients is our top priority on <a href="www.getyourlogodesign.com" target="_blank">www.getyourlogodesign.com </a> and we respect it as our own. Though we collect information from our clients, it is only used to make improvements in our customer services. Our company acknowledges that the maintenance and use of our clients' information is our responsibility. We DO NOT rent or sell the information that our clients provide us online.</p>
        ...
        <div class="margin-bottom-20">
          ...
          <p>If you have any questions about security on our Web site, you can send email us at <a href="mailto:support@getyourlogodesign.com">support@getyourlogodesign.com</a></p>
        </div>
        <div class="margin-bottom-20">
        ...
        <div class="margin-bottom-20">
          <h3>Questions</h3>
          <p>If you have any questions regarding our Privacy Policy or our use of your information, call our toll free number (+44-016-1884-0966) or email us on <a href="mailto:support@getyourlogodesign.com">support@getyourlogodesign.com</a></p>
        </div>
      </div>
    </div>
  </div>

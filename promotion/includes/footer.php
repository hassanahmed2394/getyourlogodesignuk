   ...
   $('input[name="cip"]').val(ip);
         ...
         <div class="footer-bottom">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                    <p>© Copyright 2019 Getyourlogodesign. All Rights Reserved   <!-- | <a href="<?php echo $basesurl;?>privacy.php">Privacy Policy</a> | <a href="<?php echo $basesurl;?>terms.php">Terms & Conditions</a> --> 
                    </p>
                  </div>
               </div>
            </div>
...
<div class="phone-mobile">
 <a href="tel:441617681940"> <span class="icon-phone"></span></a>
</div>
...
let ip;
 $("#phone-country,#phone-coun,#pro-phone").intlTelInput({

                        ...
                        <div class="sign-in-htm">
                           ...
                           <div class="form-group margin-bottom-0 text-center">
                              <form id="offerForm" class="offr-frm" action="webpages/topFormController.php" role="form" method="post" >
                                 ...
                                 <div id="offerFormResult" class="alert alert-success" style="font-size: 12px;display: none;">Congratulations! You've Signed up, For Further Assistance  <a href="javascript:;" onclick="setButtonURL()">
                                      <strong>Start Live Chat</strong> .</a></div>

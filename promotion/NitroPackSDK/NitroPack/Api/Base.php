...
class Base {
    ...
    protected function makeRequest($path, $headers = array(), $cookies = array(), $type = 'GET', $bodyData=array(), $async = false) {
    ...
    protected function makeRequestAsync($path, $headers = array(), $cookies = array(), $type = 'GET', $bodyData=array()) {
        return $this->makeRequest($path, $headers, $cookies, $type, $bodyData, true);
    }

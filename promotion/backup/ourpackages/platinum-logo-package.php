...
<html lang="en">
<head>
<title>Logo Design Starts With $144.99 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Platinum logo Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Platinum logo <br/>Package</h3>
          <h6><span class="old">$289.98</span> $144.99     <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=5" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Platinum Logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>Unlimited Logo Concepts (8 Initial Concepts )</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>6 Dedicated Design Artists</h6>
                  <span class="tick"></span>
                </li>
                ...
                <li>
                  <h6>2 Free Custom Startionery Designs (Letterhead, Envelope, Business Card, Invoice, <br/>Contract Cover Page Design)</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>1 Double Sided Flyer Design</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>FREE MS Word Letterhead</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>Free Email Signature</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>FREE Fax Template</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>All Final File Format (AI, PSD, EPS, PNG, GIF, JPG, PDF)</h6>
                  <span class="tick"></span>
                </li>

                 <li>
                  <h6>Facebook Banner Design</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>Instagram Design</h6>
                  <span class="tick"></span>
                </li>

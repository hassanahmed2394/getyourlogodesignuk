...
<html lang="en">
<head>
<title>Logo Design Starts With $39.00  - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        ...
        <p class="mytext">Suitable for mid level and brand revamps for existing companies.</p>
      </div>
  ...
  <div class="row">
      ...
      <li><h6>4 Revisions (Additional $9)<h6> <span class="tick"></span></li>

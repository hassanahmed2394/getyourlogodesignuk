...
<html class="no-js hover js--masthead-hidden" lang=en-gb data-js="toggled nav parent">
   <head>
      ...
      <title>Terms and Conditions | Get Your Logo Design</title>
...
<section class="sec-padding privacyPolicy privacy-text-wrapper">
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        
           <div class="container">
        <p><strong>REVISION POLICY</strong></p>
...
<p>In any event, any deposited funds for a project shall not be subject to refund after delivery if the initial design concepts are approved, or a change is requested unless GETYOURLOGODESIGN cancels or terminates your Contract for a reason other than your breach or non-performance. </p>
...
<ul>
        <p> <strong>All refund requests will be fulfilled as per the following arrangement:</strong></p>
         ...
         <li>  All refund requests should be communicated to the support department. Get Your Logo Design, based on the violation of your user agreement reserves the right to approve/disapprove your request on an individual case to case basis. </li>
         <li>  For Get Your Logo Design / Custom packages, refund will be applicable the same as it is on the single packages. 
</li>
          ...
          <li>  Claim your refund specifying your concern by contacting us via any of the following three modes:
           ...
           <li>  We will try to resolve your concern by virtue of our revision policy immediately or else will email you a refund request approval from our refund department. After the refund, your design rights would be obtained by Get Your Logo Design and you would not be able to display any version of the design sent by company. Let us also specify that:
            <ul>
               ...
               <li>  Working in collaboration with the Government Copyright Agencies Get Your Logo Design would share Copyright Acquisition information for the refunded designs that would restrict the re-use of the designs as original designs in the future.
               
               If you have any questions or concerns about our Refund Policy, please contact us by clicking here <a href="mailto:support@getyourlogodesign.com">support@getyourlogodesign.com</a>.
               </li>
            </ul>
           </li>
         </ul>

...
<html lang="en">
<head>
<title>Basic Combo Package  £444.99  - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Basic Combo  Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">£889.98</span> $444.99  <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=36" class="ordrrrr">Place Your Order</a>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>5 Logo Concepts</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>3 Dedicated Designers
</h6>
                  <span class="tick"></span>
                </li>
      ...
      <li> <h6>
      5 Pages Static Website</h6> <span class="tick">
     ...
     Team of Expert Designers & Developers</h6> <span class="tick">
      ...
      <li><h6>FREE 12 Months Hosting</h6> <span class="tick"></span></li>
      <li> <h6>
      Team of Expert Designers & Developers </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      5 Stock Photos + 3 Banner Designs </h6> <span class="tick">
 ...
 <li><h6>NOTE: Add CMS for Additional $150</h6> <span class="tick"></span></li>
      <li> <h6>Add Mobile Responsive for Additional $99</h6> <span class="tick"></span></li>

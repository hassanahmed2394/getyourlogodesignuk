...
<html lang="en">
<head>
<title>Logo Design Starts With £399.00 (Best Seller) - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">3D Gold logo Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>3D Gold logo <br/>Package</h3>
          <h6><span class="old">£580.00</span> £299.00   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=52" class="ordrrrr">Place Your Order</a>

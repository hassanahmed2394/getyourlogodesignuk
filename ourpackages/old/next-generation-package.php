...
<html lang="en">
<head>
<title>Logo Design Starts With $999.00     - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading"> Next Generation Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3> Next Generation <br/>Package</h3>
          <h6><span class="old">     $1998.00</span>$999.00            <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super level startups and brand revamps for companies.</span></h6>
          
        <a href="<?php echo $path;?>order?pack=17" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5> Next Generation Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                             <li><h6>UPTO 12 Pages</h6> <span class="tick"> </span></li>
        <li><h6>10 Stock Images</h6> <span class="tick"> </span></li>

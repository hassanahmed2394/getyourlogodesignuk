...
<html lang="en">
<head>
<title>Animation Logo Design Starts With $149.00 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Animated Bronze logo Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Animated Bronze logo <br/>Package</h3>
          <h6><span class="old">$209</span> $149.0   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=59" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Animated Bronze logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>1 Logo Concept</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>By 1 Logo Designer
</h6>
                  <span class="tick"></span>
                </li>

  <li>
                  <h6>4 Revisions (Additional $9)
</h6>
                  <span class="tick"></span>
                </li>

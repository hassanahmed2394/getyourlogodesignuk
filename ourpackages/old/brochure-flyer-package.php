...
<html lang="en">
<head>
<title>Logo Design Starts With $134.99 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Brochure/Flyer Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Brochure/Flyer <br/>Package</h3>
          <h6><span class="old">$269.98</span> $134.99     <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Brochure/Flyer Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li><h6>1 Unique Design</h6><span class="tick"></span></li>
      <li><h6>4 Design concepts (Trifold / Bi-fold)</h6><span class="tick"></span></li>

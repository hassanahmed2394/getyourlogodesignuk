...
<html lang="en">
<head>
<title>Logo Design Starts With  $199.00  - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Beginner Website Package</h2>

        <p class="mytext">Suitable for potential mid level startups and brand revamps for companies.</p>
      </div>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Beginner Website <br/>Package</h3>
          <h6><span class="old"> $398.00</span>  $199.00        <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential mid level startups and brand revamps for companies.</span></h6>
          
        <a href="<?php echo $path;?>order?pack=12" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Beginner Website Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                                      <li><h6>3 Pages</h6> <span class="tick"></span></li>
        <li><h6>3 Stock Images</h6> <span class="tick"></span></li>

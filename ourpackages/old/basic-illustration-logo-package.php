...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Basic Illustration logo Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Basic Illustration logo <br/>Package</h3>
        ...
        <a href="<?php echo $path;?>order?pack=6" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Basic Illustration Logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>2 Custom Logo Design Concepts</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>1 Dedicated Designer</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>2 Revision Rounds</h6>
                  <span class="tick"></span>
                </li>

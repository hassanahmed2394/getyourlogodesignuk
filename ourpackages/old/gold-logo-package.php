...
<html lang="en">
<head>
<title>Logo Design Starts With $119.00  - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        ...
        <p class="mytext">Suitable for potential mid level startups and brand revamps for existing companies.</p>
      </div>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">$138.00</span> 119.00    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential mid level startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=45" class="ordrrrr">Place Your Order</a>
      ...
      <li><h6>6 Revisions (Additional $9)</h6> <span class="tick"></span></li>

...
<html lang="en">
<head>
<title>Logo Design Starts With $244.99 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Startup Illustration logo Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Startup Illustration logo <br/>Package</h3>
          <h6><span class="old">$488.98</span> $244.99       <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=7" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Startup Illustration Logo Package</h5>
            ...
            <div class="body">
              <ul class="subscription-list">
                ...
                <li>
                  <h6>6 Revision Rounds</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>48 to 72 hours TAT</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>All Final Files Format (AI, PSD, EPS, PNG, GIF, JPG, PDF)</h6>
                  <span class="tick"></span>
                </li>

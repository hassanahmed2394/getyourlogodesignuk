...
<html lang="en">
<head>
<title>Logo Design Starts With $219.00 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Diamond logo Package</h2>

        <p class="mytext">Suitable for high level startups and brand revamps for existing companies.</p>
      </div>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Diamond logo <br/>Package</h3>
          <h6><span class="old">$338.00</span> $219.00    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for high level startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=47" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Diamond Logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
      <li><h6>6 Logo Concepts</h6> <span class="tick"> </span></li>
      <li><h6>By 6 Logo Designers</h6> <span class="tick"> </span></li>
      <li><h6>10 Revisions (Additional $9)</h6> <span class="tick"> </span></li>

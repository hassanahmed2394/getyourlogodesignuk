...
<html lang="en">
<head>
<title>Logo Design Starts With  $1999.00     - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Silver  Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">$3400.00</span> $1999.00    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for low-level startups and organizations.</span></h6>
          
        <a href="<?php echo $path;?>order?pack=64" class="ordrrrr">Place Your Order</a>

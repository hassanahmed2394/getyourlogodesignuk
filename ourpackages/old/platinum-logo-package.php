...
<html lang="en">
<head>
<title>Logo Design Starts With $169.00  - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        ...
        <p class="mytext">Suitable for potential high level startups and brand revamps for existing companies.</p>
      </div>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">$238.00</span> $169.00      <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential high level startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=46" class="ordrrrr">Place Your Order</a>
      ...
      <li><h6>5 Logo Concepts</h6> <span class="tick"></span</li>
      <li><h6>By 5 Logo Designers</h6> <span class="tick"></span</li>
      <li><h6>8 Revisions (Additional $9)</h6> <span class="tick"></span</li>
      ...
      <li><h6>Stationery Design (Business Card, Letterhead, Invoice)</h6> <span class="tick"></span</li>
        <li><h6>Social Media Design (Facebook, Twitter, Youtube, Instagram)</h6> <span class="tick"></span</li>

...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Bronze  Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">$3800.00</span> $1499.00    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for low-level startups and organizations.</span></h6>
          
        <a href="<?php echo $path;?>order?pack=63" class="ordrrrr">Place Your Order</a>
      ...
      <li><h6>10 App Screen Designs</h6><span class="tick"></span></li>
      <li><h6>Splash Screen Animations</h6><span class="tick"></span></li>
      <li><h6>3 Revisions (Additional $9)</h6><span class="tick"></span></li>
      <li><h6>App Logo</h6><span class="tick"></span></li>
      <li><h6>By Award Winning Logo Designers
</h6><span class="tick"></span></li>
<li><h6>Unlimited Revisions
</h6> <span class="tick"></span></li>
       <li class="heading">Free:</li>
      <li><h6>Greyscale Format</h6><span class="tick"></span></li>
      <li><h6>Color Options</h6><span class="tick"></span></li>
      <li><h6>All File Formats</h6><span class="tick"></span></li>
      <li><h6>App Icons(Phone/Tablets)</h6><span class="tick"></span></li>

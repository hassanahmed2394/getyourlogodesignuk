...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading"> Superior Website Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3> Superior Website <br/>Package</h3>
          <h6><span class="old">   $1658.00</span>$799.00           <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super level startups and brand revamps for companies.</span></h6>
          
        <a href="<?php echo $path;?>order?pack=16" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5> Superior Website Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                     <li><h6>8 Pages</h6> <span class="tick"> </span</li>
        <li><h6>8 Stock Images</h6> <span class="tick"> </span</li>

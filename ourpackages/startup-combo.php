...
<html lang="en">
<head>
<title>Logo Design Starts With £794.00 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Startup Combo  Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">£1588.00</span> £794.00  <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=37" class="ordrrrr">Place Your Order</a>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>10 Logo Concepts</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>5 Dedicated Designers
</h6>
                  <span class="tick"></span>
                </li>
      ...
      <li> <h6>
      10 Unique Pages Website </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      Content Management System (CMS) </h6> <span class="tick">
               		
               	</span></li>
      <li>Mobile Responsive</li>
      <li> <h6>
      Team of Expert Designers & Developers </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      8 Stock images </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      5 Banner Designs </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      Jquery Sliders </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      Free Google Friendly Sitemap </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      FREE 12 Months Hosting </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      5 Email Addresses </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      Complete W3C Certified HTML </h6> <span class="tick">
               		
               	</span></li>
      <li> <h6>
      Complete Deployment </h6> <span class="tick">
               		
               	</span></li>

               	 <li class="heading">Social Media</li>
      <li><h6></h6>Facebook Page Design</li>
      <li><h6></h6>Twitter Page Design</li>

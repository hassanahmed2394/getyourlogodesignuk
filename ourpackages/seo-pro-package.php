...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Seo Pro Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Seo Pro <br/>Package</h3>
          <h6><span class="old">£5199.98</span> £2,599.00  <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                  ...
                  <li>12 Press Releases (Writing and Submission)
                  <span class="tick"></span></li></li>
                  <li>90 Articles (Writing and Submission)
                  <span class="tick"></span></li></li>
                  <li>Social Bookmarking
                  <span class="tick"></span></li></li>
                  <li>Profile Link Building
                  <span class="tick"></span></li></li>
                  <li>Infographic Creation & Marketing
                  <span class="tick"></span></li></li>
                  <li>60 Blog Posts (Writing & Submission)
                  <span class="tick"></span></li></li>
                  <li>Blog Commenting
                  <span class="tick"></span></li></li>
                  <li>Forum Commenting

...
<div class="container">
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">£1688.00</span> £844.00       <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for low level startups and brand revamps for companies.</span></h6>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              ...
              <li><h6>10 Unique Pages Website</h6> <span class="tick"></span></li>
                      <li><h6>CMS / Admin Panel Support</h6> <span class="tick"></span></li>
                      <li><h6>8 Stock images</h6> <span class="tick"></span></li>
                      <li><h6>5 Banner Designs</h6> <span class="tick"></span></li>

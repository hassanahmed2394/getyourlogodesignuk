...
<html lang="en">
<head>
<title>Animation Logo Design Starts With £249.00 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Animated Gold logo Package</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Animated Gold logo <br/>Package</h3>
          <h6><span class="old">£450</span>£249.0   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=61" class="ordrrrr">Place Your Order</a>
    ...
    <div class="col-lg-8 col-md-8 col-sm-8">
      <div class="sub-list ">
          <div class="table-packages bronze">
            <div class="head">
              <h5>Animated Gold logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>3 Logo Concept</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>By 3 Logo Designer
</h6>
                  <span class="tick"></span>
                </li>
  ...
  <li>
                ...
                <li>
                  <h6>3D Logo Animation
</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>24 - 48 Hours Turn Around Time
</h6>
                  <span class="tick"></span>
                </li>

                <!-- <li>
                  <h6>By 3 Award Winning Designers</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>72 hours Turnaround Time</h6>
                  <span class="tick"></span>
                </li>
...
<li><h6>Icon</h6> <span class="tick"></span></li>
  ...
  <li><h6>100% Custom Artwork (No Template)</h6> <span class="tick"></span></li>
                <li>

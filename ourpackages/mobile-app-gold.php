...
<html lang="en">
<head>
  <title>Logo Design Starts With £2999.00     - Logo Design | Get Your Logo Design</title>
...
<body class="hompg">
  ...
  <div class="works-wrap">
    ...
    <section class="subscribe-fold sec-padding-60">
      ...
      <div class="container">
       <div class="col-md-12">
        <h2 class="myheading">Gold  Package</h2>
      ...
      <div class="row">
       <div class="col-lg-4 col-md-4 col-sm-4">
        <div class="subs-pac bronze ">
          ...
          <h6><span class="old">£5400.00</span> £2999.00    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for low-level startups and organizations.</span></h6>
          
          <a href="<?php echo $path;?>order?pack=65" class="ordrrrr">Place Your Order</a>

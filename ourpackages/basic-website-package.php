...
<html lang="en">
<head>
<title>Logo Design Starts With £99.00  - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Basic Website Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">£488.00</span> £244.00     <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for low level startups and brand revamps for companies.</span></h6>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            ...
            <!-- <li><h6>1 Page</h6> <span class="tick"> </span></li>
      <li><h6>1 Stock Images</h6> <span class="tick"> </span></li>
      ...
      <li><h6>1 Email Address</h6> <span class="tick"> </span></li>

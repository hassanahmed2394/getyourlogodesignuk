...
<html lang="en">
<head>
<title>Logo Design Starts With £499.00   - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Ultimate Website Package</h2>

        <p class="mytext">Suitable for potential high level startups and brand revamps for companies.</p>
      </div>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Ultimate Website <br/>Package</h3>
          <h6><span class="old">  £998.00</span> £499.00           <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential high level startups and brand revamps for companies.</span></h6>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Ultimate Website Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
              <li><h6>6 Pages</h6> <span class="tick"> </span></li>
        <li><h6>6 Stock Images</h6> <span class="tick"> </span></li>
        ...
        <li><h6>4 Email Addresses</h6> <span class="tick"> </span></li>

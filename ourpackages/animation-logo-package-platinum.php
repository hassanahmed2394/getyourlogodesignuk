...
<html lang="en">
<head>
<title>Animation Logo Design Starts With £349 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Animated Platinum logo Package</h2>
    ...
    <div class="col-lg-8 col-md-8 col-sm-8">
      <div class="sub-list ">
          <div class="table-packages bronze">
            <div class="head">
              <h5>Animated Platinum logo Package</h5>

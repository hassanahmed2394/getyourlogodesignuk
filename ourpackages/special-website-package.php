...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Special Website Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Special Website <br/>Package</h3>
          <h6><span class="old">£198.00</span> £99.00     <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for low level startups and brand revamps for companies.</span></h6>

...
<html lang="en">
<head>
<title>Mascot Design Starts With £549.00 (Best Seller) - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Mascot Gold logo Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h3>Mascot Gold logo <br/>Package</h3>
          <h6><span class="old">£549.00</span>£499.00   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=58" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Mascot Gold logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>4 Logo Concept</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>By 4 Logo Designer
</h6>
                  <span class="tick"></span>
                </li>
                ...
                <li>
                  ...
                  <li>
                  <h6>Stationery Design (Business Card, Letterhead, Invoice )</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>Social Media Design (Facebook, Twitter, Youtube, Instagram)</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>48 - 72 Hours Turn Around Time
</h6>
                  <span class="tick"></span>
                </li>

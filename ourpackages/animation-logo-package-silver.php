...
<html lang="en">
<head>
<title>Animation Logo Design Starts With £199 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Animated Silver logo Package</h2>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="subs-pac bronze ">
          <h3>Animated Silver logo <br/>Package</h3>
          <h6><span class="old">£350</span>£199.0   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=60" class="ordrrrr">Place Your Order</a>
    ...
    <div class="col-lg-8 col-md-8 col-sm-8">
      <div class="sub-list ">
          <div class="table-packages bronze">
            <div class="head">
              <h5>Animated Silver logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>2 Logo Concept</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>By 2 Logo Designer
</h6>
                  <span class="tick"></span>
                </li>

  <li>
                  <h6>2 Revisions (Additional <!doctype html>
<html lang="en">
<head>
<title>Animation Logo Design Starts With £199 - Logo Design | Get Your Logo Design</title>
<meta name="keywords" content="Get Your Logo Design">

        ...
        <ul class="testwrap testslider">
          <li>
            <div class="testbox">
              ...
              <div class="usertest">
                <h4>Working with Getyourlogodesign was a breeze!</h4>
                <p>I was so pleased to find a great designer who actually followed my design brief and provide the perfect Logo design and a great looking Product Sticker. I am so thankful I chose to use work with Getyourlogodesign!</p>
          ...
          <li>
            <div class="testbox">
              ...
              <div class="usertest">
                <h4>I'm happy to say that Getyourlogodesign has played a major role...</h4>
          ...
          <li>
            <div class="testbox">
              ...
              <div class="usertest">
                <h4>I can't live without Getyourlogodesign…</h4>
                ...
                <h6>Christian Adam, Business Owner</h6>
                <div class="ratings">
                  <span class="icon-star"></span>
                  <span class="icon-star"></span>
                  <span class="icon-star"></span>

...
<div class="smallbox">
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/mascot-logo=package-bronze" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=56" class="btn-packages">Place Your Order</a>
    </div>
  ...
  <div class="smallbox">
    ...
    <ul class="ticklist2 list-scroll">
      ...
      <li>Unlimited Revisions/Redraws
</li>
       <li>Stationery Design (Business Card, Letterhead, Invoice )
</li>
      <li>48 - 72 Hours Turn Around Time
</li>
       <li class="heading">Free:</li>
      <li>Color Options</li>
      <li>Greyscale Format</li>
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/mascot-logo-package-silver" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=57" class="btn-packages">Place Your Order</a>
    </div>
...
<div class="smallbox">
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/mascot-logo-package-gold" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=58" class="btn-packages">Place Your Order</a>
    </div>

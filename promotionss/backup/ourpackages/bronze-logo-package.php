...
<html lang="en">
<head>
<title>Logo Design Starts With $55.99 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Bronze logo Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">$110.98</span> $55.99   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for mid-level startups and organizations.</span></h6>
          
        <a href="<?php echo $path;?>order?pack=2" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Bronze logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>6 Logo Design Concepts</h6>
                ...
                <li>
                  <h6>24 - 48 hrs Turnaround Time</h6>
                  <span class="tick"></span>
                </li>

...
<html lang="en">
<head>
<title>Logo Design Starts With $394.99 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">3D logo Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">$788.98</span> $394.99   <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=9" class="ordrrrr">Place Your Order</a>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>3D logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>3 Unique 3D Logo Concepts</h6>
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>Light Effects and VFX</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>Fully Rendered</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>Multiple 3D Angles</h6>
                  <span class="tick"></span>
                </li>

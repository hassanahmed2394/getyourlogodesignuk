                        ...
                        <div class="sign-in-htm">
                           ...
                           <div class="form-group margin-bottom-0 text-center">
                              <form id="offerForm" class="offr-frm" role="form" method="post" novalidate="novalidate">
                                 ...
                                 <input type="text" class="form-control" id="phone" name="Number" aria-describedby="phone" placeholder="Phone" required="">
                                 <textarea name="Message" required=""  id="" placeholder="Talk about your project"></textarea>

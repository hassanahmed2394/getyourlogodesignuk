    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="cmp-heading-sec">
          <h1>$699.99. Yes. That’s all it takes for complete branding at Get Your Logo Design.</h1>
        ...
        <div class="banner-main text-center">
            ...
            <div class="col-lg-12 text-left">
              <div class="midbanner-text midbrand">
                  ...
                  <del>$1,400.<small>99</small></del>
                  <h1><span class="">$</span>699.99</h1>
                  <!-- <span class="subh">50% Discounted  Price</span> -->
                  
                  <div class="bub-btn brandpackage">
                    <span class="button--bubble__container">
                      <a href="<?php echo $path;?>order?pack=10" class="button button--bubble largefont">
                       Order Now
                      </a>
                    </span>
                    <a href="<?php echo $path;?>includes/complete-branding-solution" class="cmp-view-btn">View Details</a>
                  </div>
                  <div class="img-wrp">

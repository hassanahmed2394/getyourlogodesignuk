...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Special logo Package</h2>
  ...
  <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for companies.</span></h6>
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Special logo Package</h5>
              <!-- <h6><b>$</b><span>1,600.00</span> only</h6> -->
            </div>
            <div class="body">
              <ul class="subscription-list">
                <li>
                  <h6>1 Logo Design Concepts</h6>
                ...
                <li>
                  <h6>Final Files (.AI, .PSD, .EPS, .JPEG, .SVG, .PDF, Tiff)</h6>
                  <span class="tick"></span>
                </li>
                 <li>
                  <h6>Greyscale Format
                ...
                <li>100% Custom Artwork (No Template)
                  <span class="tick"></span>
                </li>
                <li>
                  <h6>100% Ownership Rights
</h6>
                  <span class="tick"></span>
                </li>
                 <li>
                  <h6>100% Money Back Guarantee

</h6>
                  <span class="tick"></span>
                </li>
                 <li>
                  <h6>100% Real Account Manager (No Bots)

</h6>
                  <span class="tick"></span>
                </li>
                 <li>
                  <h6>24/7 Support (Email, Chat, Call, SMS, Whatsapp)

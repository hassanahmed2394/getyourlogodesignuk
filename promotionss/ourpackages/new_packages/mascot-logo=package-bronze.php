...
<html lang="en">
<head>
<title>Logo Design Starts With $299.99 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Mascot Bronze logo Package</h2>
  ...
  <div class="row">
  	...
  	<div class="col-lg-8 col-md-8 col-sm-8">
          ...
          <div class="table-packages bronze">
            <div class="head">
              <h5>Mascot Bronze logo Package</h5>

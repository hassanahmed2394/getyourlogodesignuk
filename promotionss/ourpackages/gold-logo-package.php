...
<html lang="en">
<head>
<title>Logo Design Starts With $111.99 - Logo Design | Get Your Logo Design</title>
...
<div class="container">
   <div class="col-md-12">
        <h2 class="myheading">Gold logo Package</h2>
  ...
  <div class="row">
  	<div class="col-lg-4 col-md-4 col-sm-4">
          ...
          <h6><span class="old">$222.98</span> $111.99    <!-- <b>USD</b> --> <span><b class="monthss"></b>Suitable for potential super-startups and brand revamps for existing companies</span></h6>
          
        <a href="<?php echo $path;?>order?pack=4" class="ordrrrr">Place Your Order</a>
          ...
          <div class="table-packages bronze">
            ...
            <div class="body">
              <ul class="subscription-list">
                ...
                <li>
                  <h6>FREE Icon Design</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>FREE Grayscale Format</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>FREE Color Options</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>FREE File Formats (PSD, PDF, AI, JPEG, PNG)</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>FREE Vector Files</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>Stationery Design(Business Card, Letterhead, Envelope, Invoice)</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>6 Dedicated Designers</h6>
                  <span class="tick"></span>
                </li>

                <li>
                  <h6>48 hrs Turnaround Time</h6>
                  <span class="tick"></span>
                </li>

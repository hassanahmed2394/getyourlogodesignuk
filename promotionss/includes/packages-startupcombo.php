...
<section class="mid-banner sec-padding-100">
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="cmp-heading-sec">
          <h1>£1,199.99. Yes. That’s all it takes for complete branding at Get Your Logo Design.</h1>
          <p>We have ample experience when it comes to transforming brands and their identities. Get Your Logo Design uses all that into creating a unique brand image for you in packages that are made to suit your needs and budget. </p>  
        </div>
      </div> 
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="banner-main text-center">
            <h2>Complete Branding Solution</h2>
            <div class="clearfix"></div>
            <div class="col-lg-12 text-left">
              <div class="midbanner-text midbrand">
                  <div class="listsss brand-listsss">
                    <ul>
                      <li>
                        ...
                        <div class="packaging-lists part-new">
                          <ul>
                        ...
                        <div class="packaging-lists lst-pack part-new">
                          <ul>
                      ...
                      <li>
                        ...
                        <div class="packaging-lists lstpagck">
                          <ul>
                  ...
                  <del>£2,398.<small>99</small></del>
                  <h1><span class="">£</span>1199.99</h1>
                  <!-- <span class="subh">50% Discounted  Price</span> -->
                  
                  <div class="bub-btn brandpackage">
                    <span class="button--bubble__container">
                      <a href="<?php echo $path;?>order?pack=41" class="button button--bubble largefont">
                       Order Now
                      </a>
                    </span>
                    <a href="<?php echo $path;?>ourpackages/complete-branding-solution" class="cmp-view-btn">View Details</a>
                  </div>
                  <div class="img-wrp">

<div  id="pricing-carosul3" class="owl-carousel owl-theme pl-2 pr-2">
<div class="item">
          <div class="package-box text-center">
                         ...
                         <a class="btn-order green-btn" href="<?php echo $path;?>order?pack=56">ORDER NOW</a>
             </div>
</div>
...
<div class="item">
          <div class="package-box text-center">
                         ...
                         <a class="btn-order green-btn" href="<?php echo $path;?>order?pack=57">ORDER NOW</a>
             </div>
</div>
...
<div class="item">
          <div class="package-box text-center seller">
                         ...
                         <a class="btn-order green-btn" href="<?php echo $path;?>order?pack=58">ORDER NOW</a>
             </div>
</div>

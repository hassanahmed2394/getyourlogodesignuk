<div  id="pricing-carosul4"class="owl-carousel owl-theme pl-2 pr-2">
<div class="item">
          <div class="package-box text-center">
                         ...
                         <span class="actual-price packgePrice">£99.00</span><span class="sale-price"> £180.00</span>
                         <div class="scroll">
                         ...
                         <a class="btn-order green-btn" href="<?php echo $path;?>order?pack=50">ORDER NOW</a>
             </div>
</div>
...
<div class="item">
          <div class="package-box text-center">
                         ...
                         <a class="btn-order green-btn" href="<?php echo $path;?>order?pack=51">ORDER NOW</a>
             </div>
</div>
...
<div class="item">
          <div class="package-box text-center seller">
                         ...
                         <span class="actual-price packgePrice">£299.00</span><span class="sale-price">£399.00 </span>
                         <div class="scroll">
                            <ul style="margin-bottom: 18px;">
                         ...
                         <a class="btn-order green-btn" href="<?php echo $path;?>order?pack=52">ORDER NOW</a>
             </div>
</div>

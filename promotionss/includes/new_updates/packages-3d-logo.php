<div  id="pricing-carosul2"class="owl-carousel owl-theme pl-2 pr-2">
<div class="item">
          <div class="package-box text-center">
                         ...
                         <a class="btn-order green-btn" href="<?php echo $path;?>order?pack=53">ORDER NOW</a>
             </div>
</div>
...
<div class="item">
      ...
      <li>48 - 72 Hours Turn Around Time</li>
                         ...
                         <a class="btn-order green-btn" href="<?php echo $path;?>order?pack=54">ORDER NOW</a>
             </div>
</div>
...
<div class="item">
      ...
      <li><strong>48 - 72 Hours Turn Around Time</strong></li>
                         ...
                         <a class="btn-order green-btn" href="<?php echo $path;?>order?pack=55">ORDER NOW</a>
             </div>
</div>

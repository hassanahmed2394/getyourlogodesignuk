...
<div class="smallbox">
    <h2>$249.00 <span><s>$380.00</s></span> </h2>
    <h4>3D Bronze Logo<br> Package</h4>
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/3dd-logo=package-bronze" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=53" class="btn-packages">Place Your Order</a>
    </div>

  </div>
  <div class="smallbox">
    <h2>$399.00 <span><s>$580.00</s></span> </h2>
    <h4>3D Silver Logo<br> Package</h4>
    <p>Suitable for low-level startups and organizations.</p>
    <div class="hrline"></div>
    <!-- <h3>Payable Amount</h3> -->
    <ul class="ticklist2 list-scroll">
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/3dd-logo-package-silver" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=54" class="btn-packages">Place Your Order</a>
    </div>
...
<div class="smallbox">
    ...
    <h2>$599.00 <span><s>$780.00</s></span> </h2> 

    <h4>3D Gold Logo<br> Package</h4>
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/3dd-logo-package-gold" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=55" class="btn-packages">Place Your Order</a>
    </div>

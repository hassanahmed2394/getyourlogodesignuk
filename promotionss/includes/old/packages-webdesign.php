<div class="smallboxes packagesslider">
  ...
  <div class="smallbox">
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/starter-website-package" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=11" class="btn-packages">Place Your Order</a>
    </div>
  </div>
  ...
  <div class="smallbox">
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/corporate-website-package" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=14" class="btn-packages">Place Your Order</a>
    </div>
  </div>
  ...
  <div class="smallbox">
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/superior-website-package" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=16" class="btn-packages">Place Your Order</a>
    </div>
  </div>
  ...
  <div class="smallbox">
    <h2>$999.00 <span><s> $1998.00</s></span> </h2>
    <h4> Next Generation<br> Package </h4>
    <p>Suitable for potential super level startups and brand revamps for companies.</p>
    <div class="hrline"></div>
    ...
    <div class="price-btnwrap">
      <a href="<?php echo $path;?>ourpackages/next-generation-package" class="vdetails">View Details</a>
      <a href="<?php echo $path;?>order?pack=17" class="btn-packages">Place Your Order</a>
    </div>
  </div>
  ...
  <div class="smallbox">
    <h2>$1499.00 <span><s> $2998.00</s></span> </h2>
    <h4> Infinity<br> Package </h4>
    <p>Suitable for potential super level startups and brand revamps for companies.</p>
    <div class="hrline"></div>
    ...
    <ul class="ticklist2 list-scroll">
      <li>Unlimited Pages</li>
        ...
        <li>Unlimited Image/Video Slider</li>
        <li>Enquiry Form</li>
        <li>Photo Gallery</li>
        <li>Social Networks Integration</li>
        <li class="heading">FREE</li>
